#!/bin/bash -l
#SBATCH --job-name=r4_eval                    # Job name
#SBATCH --gres=gpu:NVIDIA_L40S:1
# --nodelist=cn532                         # Number of nodes
#SBATCH --nodes=1                         # Number of nodes
#SBATCH --cpus-per-task=8                 # Number of CPU cores per TASK
#SBATCH --mem=24GB
#SBATCH -o slurm/logs/slurm-r4_eval_ceb-%j.out
...
# Evaluator Choice
export EVALUATOR="atla"     # chatgpt or prometheus or atla
...
export SYSTEM_PROMPT_TYPE="really_4x"
